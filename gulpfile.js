...
// Project related.
var project                 = 'exclusive-pillar'; // Project Name.
var projectURL              = 'localhost/exclusive-pillar'; // Project URL. Could be something like localhost:8888.
...
var jsVendorDestination     = './scripts/vendor/'; // Path to place the compiled JS vendors file.
var jsVendorFile            = 'vendors'; // Compiled JS vendors file name.
// Default set to vendors i.e. vendors.js.

// JS Custom related.
var jsCustomSRC             = './scripts/dist/*.js'; // Path to JS custom scripts folder.
var jsCustomDestination     = './scripts/dist/'; // Path to place the compiled JS custom scripts file.
var jsCustomFile            = 'main.min'; // Compiled JS custom file name.
