...
routerApp.config(function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('skills.webdev', {
            url: '/webdev',   
            template: '<p>currently undergoing front-end web development training under <b><span style="color:orange">REKA studios</span></b>. about 3 weeks in, and now i can fairly understand html and css; know how to incorporate and work with bootstrap, jquery & angularjs in producing my own webpage. not much really... just enough to produce this simple page you are currently looking at! :)</p><p>Currently I am working on a (commercial) Japanese event webpage. Link <span><a href="http://www.hanniball.jp">Here!</a></span></p>'         
        })
        .state('skills.geophy', {
            url: '/geophy',   
